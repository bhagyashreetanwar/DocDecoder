...
set_target_properties(orc::orc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/liborc.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/liborc.dylib"
  )

list(APPEND _cmake_import_check_targets orc::orc )
list(APPEND _cmake_import_check_files_for_orc::orc "${_IMPORT_PREFIX}/lib/liborc.dylib" )

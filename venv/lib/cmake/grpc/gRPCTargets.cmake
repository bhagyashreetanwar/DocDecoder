...
set_target_properties(gRPC::address_sorting PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "protobuf::libupb;m;Threads::Threads"
)
...
set_target_properties(gRPC::grpc PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "OpenSSL::SSL;OpenSSL::Crypto;gRPC::gpr;-framework CoreFoundation"
)
...
set_target_properties(gRPC::grpc_unsecure PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::gpr;-framework CoreFoundation"
)
...
set_target_properties(gRPC::grpc++ PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libupb;m;Threads::Threads;absl::absl_check;absl::absl_log;gRPC::grpc;protobuf::libprotobuf"
)
...
set_target_properties(gRPC::grpc++_alts PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libupb;m;Threads::Threads;gRPC::grpc++"
)
...
set_target_properties(gRPC::grpc++_unsecure PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libupb;m;Threads::Threads;absl::absl_check;absl::absl_log;gRPC::grpc_unsecure;protobuf::libprotobuf"
)
...
set_target_properties(gRPC::grpc_authorization_provider PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libupb;m;Threads::Threads;re2::re2;ZLIB::ZLIB;absl::config;absl::no_destructor;absl::flat_hash_map;absl::flat_hash_set;absl::inlined_vector;absl::function_ref;absl::hash;absl::type_traits;absl::statusor;absl::span;absl::utility;c-ares::cares;gRPC::gpr;gRPC::address_sorting"
)
...
set_target_properties(gRPC::grpc_plugin_support PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libupb;m;Threads::Threads;absl::status;protobuf::libprotobuf;protobuf::libprotoc"
)
